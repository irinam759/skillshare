        ...
        return(
            <div className = "p-homepage">
                ...
                <Row className="justify-content-center text-center px-lg-5 mx-lg-5 mx-md-4 mx-sm-3 mx-xs-0" >
                    ...
                    <MainCard image="skillshare/images/Questions-and-answers.png" text="חפש בעל מיומנות/מורה/מאמן" page="./Teachers" color="card-red"></MainCard>
                    <MainCard image="skillshare/images/Community.png" text=" חפש קבוצה" page="./Groups" color="card-blue"></MainCard>
                    <MainCard image="skillshare/images/Power-of-knowledge.png" text=" צור קבוצה" page="./CreateGroup" color="card-yellow"></MainCard> 
